...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 w-full h-[10dvh] z-30 bg-gradient-to-r from-blue-900 via-black to-black shadow-lg shadow-blue-900/40 backdrop-blur-md">
